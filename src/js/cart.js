export function initCart() {
  ...
  const closeCartBtn = document.querySelector('.close-cart-bnt');
  ...
  function countTotal() {
    ...
    const totalNum = document.getElementById('cart-total-number');
  ...
  function checkout() {
    const totalPrice = document.getElementById('cart-total-number').innerHTML;
